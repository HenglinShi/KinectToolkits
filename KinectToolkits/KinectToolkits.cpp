...
#define CHANNEL 4
int desiredColorFrameHeight = 540;
int desiredColorFrameWidth = 960;
...
string DESTINATIONPATH = "C:\\Users\\hshi\\Documents\\SampleOutput";
					...
					if (body) {
						...
						if (SUCCEEDED(body->get_IsTracked(&bodyTracked))) {
							...
							if (bodyTracked) {
								...
								resultMat = resultMat + drawAperson(jointsPoints, skeletonColor, 10, resultMat);
								break;
								body->Release();
							}
						}
